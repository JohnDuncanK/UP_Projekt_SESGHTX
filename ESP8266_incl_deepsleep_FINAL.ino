...
const char* ssid     = "hackerwifi"; //wifi-navn
...
const char* serverNavn = "http://10.34.130.116//post-esp-data.php";
...
void setup() {
  ...
  ESP.deepSleep(10e6);
  //begynder deep sleep. Alt kode der er skrevet efter dette, bliver ikke executet
}
...
void loop() {
  ...
  /*
  Her stpr intet da Deep-Sleep-cyklussen fungerer ved RST (reset-knappen).
  Dvs. at ESP-modulet stortset er slukket helt, indtil at RTC kortslutter på en pin
  ESP-modulet betragter som reset. Derfor vil void setup() køre efter hver 'wakeup'
  */
